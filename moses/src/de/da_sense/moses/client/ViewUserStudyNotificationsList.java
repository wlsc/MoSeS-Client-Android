...
/**
 * XXX: This was used in the old version of the app. It had a tab for the user 
 * studies which where available. Available apps and user studies where something
 * different. Maybe some of the logic here should be incorporated into the 
 * available tab. And instead of showing all apps which the server lists as
 * available only show those that are still valid (start/end date).
 * 
...
//				rowMap.put("description", descriptionLbl);
		...
		SimpleAdapter contentAdapter = new SimpleAdapter(this, listContent, R.layout.availablestudieslistitem,
				new String[] { "name" }, new int[] { R.id.userstudylistitemtext });
