...
public interface ApkInstallObserver {
	 ...
	 * 
	 * @param apk the apk file that was installed
	 */
	public void apkInstallSuccessful(File apk, ExternalApplication appRef);
	/**
	 * called if the installation encountered no errors per se, but the user chose to cancel the installation.
	 * 
	 * @param apk the apk file that was meant to be installed
	 */
	 ...
	 * @param appRef 
	 * @param e exception that was thrown somewhere in the process, or null if there is no such exception.
	 */
