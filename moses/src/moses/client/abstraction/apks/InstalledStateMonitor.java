...
/**
 * Monitors installed apps whether their corresponding apps on the disk are still installed and takes the appropriate actions
 * 
 * @author Simon L
 *
 */
public class InstalledStateMonitor {
	...
	/**
	 * checks if the installed app database and the actually installed apps are consistent
	 * 
	 * @param context
	 * @return true for a consistent state, and false, if the state was inconsistent, and was made consistent in the process.
	 */
	...
	/**
	 * Handles the occurence of an app that this application thinks it is installed, but it is actually not.
	 * By default, the app is forgotten, and an Uninstallation notification is sent to the server.
	 * 
	 * @param inconsistentApp
	 * @param context
	 */
	private void handleInconsistentApp(
			InstalledExternalApplication inconsistentApp, Context context) {
